...
MOA_MARKER_PREFIX = "__JACKY_MOA_TURN_V1__"
...
def _coerce_float_or_none(value: Any) -> float | None:
    ...
    provider default applies', matching how a single-model Jacky agent
...
def exact_moa_preset_name(config: Any, text: str) -> str | None:
    ...
    ``jacky_cli/model_switch.py``) to recognize a bare ``/model <preset>``
