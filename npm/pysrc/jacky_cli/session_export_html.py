"""
HTML Export generator for Jacky sessions.
...
ICON_JACKY = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FFD700" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="m9 12 2 2 4-4"/></svg>'
...
<body>
    <div class="layout {layout_class}">
        ...
        <div class="main-content">
            ...
            <footer>
                Built with ☤ Jacky Agent • Generated on {generated_at}
            </footer>
        </div>
    </div>
...
def generate_multi_session_html_export(sessions: List[Dict[str, Any]]) -> str:
    ...
    for s in sessions:
        sid = str(s.get("id", "N/A"))
        escaped_sid = _escape_html(sid)
        title = s.get("title") or "Jacky Session"
    ...
    return HTML_TEMPLATE.format(
        page_title="Jacky Session Export" if is_multi else _escape_html(sessions[0].get("title", "Jacky Session")),
