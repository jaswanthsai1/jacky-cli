...
Invoked by ``jacky kanban decompose [task_id | --all]`` and the
...
* Mirrors the shape of ``jacky_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Jacky Agent board.
...
def _profile_author() -> str:
    """Mirror of ``jacky_cli.kanban._profile_author``."""
    return (
