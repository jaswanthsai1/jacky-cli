"""Client for uploading ``jacky debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``jacky debug share``.
...
NAS_BASE = os.environ.get(
    "JACKY_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "jacky-agent/debug-share"
