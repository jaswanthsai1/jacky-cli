...
Usage:
    jacky pairing list              # Show all pending + approved users
    jacky pairing approve <platform> <code>  # Approve a pairing code
    jacky pairing revoke <platform> <user_id> # Revoke user access
    jacky pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle jacky pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: jacky pairing {list|approve|revoke|clear-pending}")
        print("Run 'jacky pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.jacky/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'jacky pairing list' to see pending codes.\n")
