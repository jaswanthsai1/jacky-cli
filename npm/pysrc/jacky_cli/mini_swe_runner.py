#!/usr/bin/env python3
"""
SWE Runner with Jacky Trajectory Format

A runner that uses Jacky-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Jacky-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Jacky-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Jacky format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Jacky-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Jacky-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Jacky Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Jacky-Agent's built-in execution environments
    and outputs trajectories in Jacky-Agent format.
    """
    ...
    def _convert_to_jacky_format(
        ...
        """
        Convert internal message format to Jacky trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Jacky trajectory format
        trajectory = self._convert_to_jacky_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Jacky trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Jacky Trajectory Format")
    print("=" * 60)
