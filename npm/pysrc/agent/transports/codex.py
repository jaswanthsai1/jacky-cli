...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        from jacky_cli.run_agent import DEFAULT_AGENT_IDENTITY
        ...
        # that would silently route around Jacky's web-provider config and
        ...
        # native search engine for xAI sessions instead of Jacky's
        # configured web provider (Tavily/etc.), and those results bypass
        # Jacky's tool-trace / citation plumbing (they arrive baked into the
