...
first content token) routinely exceed Jacky's default chat-model
stale detectors:

* Stream stale detector:   ``JACKY_STREAM_STALE_TIMEOUT``     default 180s
                           ``agent/chat_completion_helpers.py:2544``
* Non-stream stale detector: ``JACKY_API_CALL_STALE_TIMEOUT``  default 90s
                           ``run_agent.py:1140``
