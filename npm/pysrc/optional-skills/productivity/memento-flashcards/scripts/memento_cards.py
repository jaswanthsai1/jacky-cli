...
Data file: $JACKY_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_JACKY_HOME = Path(os.environ.get("JACKY_HOME", Path.home() / ".jacky"))
DATA_DIR = _JACKY_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
