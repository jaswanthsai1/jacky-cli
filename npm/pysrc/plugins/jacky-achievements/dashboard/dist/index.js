(function () {
  ...
  if (!SDK || !window.__JACKY_PLUGINS__) return;
  ...
  function api(path, options) {
    ...
    // Hand-rolling fetch + reading window.__JACKY_SESSION_TOKEN__ directly
  ...
  window.__JACKY_PLUGINS__.register("hermes-achievements", AchievementsPage);
})();
