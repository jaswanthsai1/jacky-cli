# Jacky Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.jacky/plugins/jacky-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.jacky/plugins/jacky-achievements/scan_checkpoint.json`.
