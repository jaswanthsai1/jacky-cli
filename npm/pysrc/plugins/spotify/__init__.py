...
``_check_spotify_available()`` — when the user has not run ``jacky auth
spotify``, the tools remain registered (so they appear in ``jacky
...
The Spotify auth flow (``jacky auth spotify``), CLI plumbing, and docs
