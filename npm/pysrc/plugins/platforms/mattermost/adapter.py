...
required — uses aiohttp which is already a Jacky dependency.
...
def interactive_setup() -> None:
    ...
    ``jacky_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Jacky delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # jacky_cli/setup.py::_setup_mattermost function.
