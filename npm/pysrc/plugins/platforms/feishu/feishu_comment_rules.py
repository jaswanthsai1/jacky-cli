...
Config: ~/.jacky/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.jacky/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_jacky_home()`` helper (JACKY_HOME-aware and
...
RULES_FILE = get_jacky_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_jacky_home() / "feishu_comment_pairing.json"
