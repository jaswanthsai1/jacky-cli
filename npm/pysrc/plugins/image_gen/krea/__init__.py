...
# Jacky uses 3 abstract aspect ratios. Map to Krea's enum (which is wider).
        ...
        **kwargs: Any,
        ...
        if managed is not None:
            ...
            if not auth_token:
                return error_response(
                    error=(
                        "KREA_API_KEY not set. Run `jacky tools` → Image "
        ...
        headers = {
            ...
            "User-Agent": "Jacky-Agent/1.0 (krea-image-gen)",
        }
        if managed is not None:
