...
try:
    ...
    _JACKY_VERSION = "0.0.0"

_APP_VERSION = _JACKY_VERSION
_BOT_VERSION = _JACKY_VERSION
_YUANBAO_INSTANCE_ID = str(JACKY_INSTANCE_ID)  # single source: yuanbao_proto.JACKY_INSTANCE_ID
