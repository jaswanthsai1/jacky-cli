...
Hooks are discovered from ~/.jacky/hooks/ directories, each containing:
...
HOOKS_DIR = get_jacky_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"jacky_hook_{hook_name}"
