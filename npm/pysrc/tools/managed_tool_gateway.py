...
def auth_json_path():
    """Return the Jacky auth store path, respecting JACKY_HOME overrides."""
    return get_jacky_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`jacky tools`, banner/status paint, provider
