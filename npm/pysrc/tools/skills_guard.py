...
Trust levels:
  - builtin:   Ships with Jacky. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.jacky/\.env|\~/\.jacky/\.env',
     "jacky_env_access", "critical", "exfiltration",
     "directly references Jacky secrets file"),
    ...
    (r'\.jacky/config\.yaml|\.jacky/SOUL\.md',
     "jacky_config_mod", "critical", "persistence",
     "references Jacky configuration files directly"),
...
# scan. `.skillignore` is the Jacky-native name; `.clawhubignore` is honored
