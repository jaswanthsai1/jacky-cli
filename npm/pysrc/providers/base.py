...
def _profile_user_agent() -> str:
    """Return a ``jacky-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from jacky_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"jacky-cli/{_ver}"
    except Exception:
        return "jacky-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # jacky-cli UA so the catalog endpoint is reachable.
