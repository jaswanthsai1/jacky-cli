...
(``~/.jacky/plans/god-file-decomposition.md``, Phase 3 mechanical mixin lifts).
...
class GatewayAuthorizationMixin:
    ...
    def _adapter_group_has_sender_allowlist(
        ...
        *,
        ...
        restricting which senders inside that group can invoke Jacky. If such a
    ...
    def _is_user_authorized(self, source: SessionSource) -> bool:
        ...
        # (jacky gateway pairing approve / the authenticated dashboard) — an
