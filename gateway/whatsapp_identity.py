...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$JACKY_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_jacky_dir("platforms/whatsapp/session", "whatsapp/session")
