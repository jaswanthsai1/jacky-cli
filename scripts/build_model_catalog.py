#!/usr/bin/env python3
"""Build the Jacky Model Catalog — a centralized JSON manifest of curated models.
...
Jacky CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Jacky release.
...
# Ensure JACKY_HOME is set for imports that touch it at module level.
os.environ.setdefault("JACKY_HOME", os.path.join(os.path.expanduser("~"), ".jacky"))

from jacky_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "jacky-agent repo",
            "docs": "https://jacky-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
