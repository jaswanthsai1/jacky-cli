...
VERSION_FILE = REPO_ROOT / "jacky_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "sunsky.lau@gmail.com": "liuhao1024",  # PR #56993 salvage (gateway: process-level JACKY_HOME for pid/lock/status identity files; #56986)
    ...
    "wyuebei@gmail.com": "wyuebei-cloud",  # PR #56640 salvage (jacky journey: replace GNU-only %-d strftime with dt.day for Windows)
    ...
    "jacky.wanderer@yahoo.com": "trismegistus-wanderer",  # PR #31856 salvage (gateway: defer idle-TTL agent-cache eviction until the session store says the session actually expired, so the expiry watcher can still fire MemoryProvider.on_session_end with the live transcript; #11205)
    ...
    "me@keslerm.com": "keslerm",  # PR #3459 salvage (gateway: 'log' tool_progress mode — silent in chat, tool calls appended to ~/.jacky/logs/tool_calls.log via rotating handler; duplicate of #3458 by @dlkakbs who submitted 4 min earlier — both credited)
    ...
    "121278003+Cossackx@users.noreply.github.com": "Cossackx",  # PR #52528 salvage (Windows jacky-shim resolution + prefer --update on recovery; #52378)
    ...
    "274096618+jacky-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "jacky@nousresearch.com": "NousResearch",
    ...
    "sberan@gmail.com": "sberan",  # PR #54494 salvage (--connect-timeout flag on jacky mcp add)
    ...
    "jacky@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (JACKY_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (JACKY_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: jacky-eval community link)
    ...
    "jackyagent26@gmail.com": "jackyagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+jackyagent26@users.noreply.github.com": "jackyagent26",
    ...
    "vigo@jacky": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Jacky runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level JACKY_HOME state files)
    ...
    "zhchl@jacky-agent.local": "8294",  # PR #50572 salvage (honor config context_length on banner)
}
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "jacky@nousresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/jaswanthsai1/jacky-cli",
