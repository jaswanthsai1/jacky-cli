...
DEFAULT_DATASETS = [
    ...
    "jaswanthsai1/jacky-cli-megascience-sft1",
    "jaswanthsai1/jacky-cli-Thinking-GLM-4.7-SFT2",
    "jaswanthsai1/jacky-cli-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-jacky-agent"
]
...
def run_compression(input_dir: Path, output_dir: Path, config_path: str):
    ...
    from jacky_cli.trajectory_compressor import TrajectoryCompressor, CompressionConfig
