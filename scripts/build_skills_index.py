#!/usr/bin/env python3
"""Build the Jacky Skills Index — a centralized JSON catalog of all skills.
...
`jacky skills search/install` can use it without hitting the GitHub API.
...
# Ensure JACKY_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Jacky Skills Index...", flush=True)
