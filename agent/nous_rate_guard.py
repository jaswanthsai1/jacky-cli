...
(3 SDK retries x 3 Jacky retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = os.path.join(os.path.expanduser("~"), ".jacky")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Jacky, ...) behind one endpoint.  A 429 can mean either:
