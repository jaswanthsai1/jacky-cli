...
def _resolve_concurrent_tool_timeout() -> float | None:
    raw = os.getenv("JACKY_CONCURRENT_TOOL_TIMEOUT_S", "").strip()
    if not raw:
    ...
    try:
        ...
        logger.warning(
            "invalid JACKY_CONCURRENT_TOOL_TIMEOUT_S=%r; using %.0fs",
            raw,
...
def _flush_session_db_after_tool_progress(
    ...
    *,
    ...
    current Jacky process before the normal turn-end persistence path runs.
