"""Vertex AI (Google Cloud) adapter for Jacky Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Jacky to use Gemini models via Google Cloud with
...
# who installed plain `jacky-agent` and only later selected a Gemini model.
try:
