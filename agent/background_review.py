...
See the ``jacky-agent-dev`` skill (``references/self-improvement-loop.md``)
...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Bundled skills (shipped with Jacky, e.g. 'jacky-agent').\n"
    "  • Hub-installed skills (installed via 'jacky skills install').\n"
    "Pinned skills (marked via 'jacky curator pin') CAN be improved — "
...
def build_memory_write_metadata(
    ...
    *,
    ...
    metadata: Dict[str, Any] = {
        ...
        "platform": agent.platform or os.environ.get("JACKY_SESSION_SOURCE", "cli"),
        "tool_name": "memory",
    }
    if task_id:
...
def _run_review_in_thread(
    ...
    try:
        ...
        with thread_scoped_silence():
            ...
            # scratch (fresh _jacky_now() timestamp, fresh
