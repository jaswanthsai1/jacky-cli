...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``jacky logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Jacky only initiates compaction in "jacky" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Jacky preflight compression for codex app-server "
                "(mode=%s); Jacky will not start thread compaction here.",
