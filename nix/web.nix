# nix/web.nix — Jacky Web Dashboard (Vite/React) frontend build
{ pkgs, jackyNpmLib, ... }:
let
  npm = jackyNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "jacky-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../jacky_cli/web_dist for the
