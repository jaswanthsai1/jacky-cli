...
Only included in the jacky-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Jacky-Agent (https://github.com/jaswanthsai1/jacky-cli)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_jacky_home() / "cache" / "discord_capabilities.json"
