#!/usr/bin/env python3
"""Read the in-app terminal pane in the Jacky desktop GUI.
...
def read_terminal_tool(
    ...
    if callback is None:
        return tool_error("read_terminal is only available in the Jacky desktop app.")
...
READ_TERMINAL_SCHEMA = {
    "name": "read_terminal",
    "description": (
        "Read what's currently shown in the in-app terminal pane of the Jacky "
