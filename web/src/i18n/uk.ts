...
export const uk: Translations = {
  ...
  status: {
    ...
    stopped: "Зупинено",
    updateJacky: "Оновити Jacky",
    updatingJacky: "Оновлення Jacky…",
  ...
  pluginsPage: {
    ...
    headline:
      "Знаходьте, встановлюйте, вмикайте та оновлюйте плагіни Jacky (паритет з `jacky plugins`).",
    ...
    removeConfirm: "Видалити цей плагін з ~/.jacky/plugins/?",
    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.jacky/plugins.",
  ...
  skills: {
    ...
    filters: "Фільтри",
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.jacky/skills/",
  ...
  env: {
    ...
    customHint: "Довільні змінні середовища, збережені у вашому .env, які Jacky не розпізнає. Використовуйте їх для впровадження змінних середовища для навичок, серверів MCP або власних інструментів.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Колекційні значки Jacky, отримані з реальної історії сеансів. Відомі, але ще не виконані досягнення показані як Виявлені; Секретні досягнення залишаються прихованими, доки не з'явиться перший відповідний сигнал.",
      scan_subtitle:
        "Сканування історії сеансів Jacky. Перше сканування на великих історіях може тривати 5–10 секунд.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Останнє",
      latest_hint_empty: "запускайте Jacky частіше",
      none_yet: "Поки немає",
    },
    state: {
      unlocked: "Розблоковано",
    ...
    guide: {
      ...
      secret_body:
        "Секрети приховують свій точний тригер. Щойно Jacky побачить пов'язаний сигнал, картка стає Виявленою та показує свою умову.",
      scan_status_header: "Стан сканування",
      scan_status_body:
        "Jacky одноразово сканує локальну історію, а потім картки з'являться автоматично. Якщо це триває кілька секунд — нічого не зависло.",
