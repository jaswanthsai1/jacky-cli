...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateJacky: "Aggiorna Jacky",
    updatingJacky: "Aggiornamento di Jacky…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Jacky (parità con `jacky plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.jacky/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.jacky/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.jacky/skills/",
  ...
  env: {
    ...
    customHint: "Variabili d'ambiente arbitrarie salvate nel tuo .env che Jacky non riconosce. Usale per iniettare variabili d'ambiente per skill, server MCP o i tuoi strumenti.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge Jacky da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni Jacky in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Jacky di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Jacky rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "Jacky sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
