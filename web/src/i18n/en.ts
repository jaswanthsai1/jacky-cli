...
export const en: Translations = {
  ...
  status: {
    ...
    updateJackyConfirmMessage:
      "This runs jacky update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateJackyConfirmNow: "Update now",
    updateJackyConfirmTitle: "Update Jacky?",
    updatingJacky: "Updating Jacky…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Jacky plugins (`jacky plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.jacky/plugins/?",
    removeHint: "Only user-installed plugins under ~/.jacky/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.jacky/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Jacky doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Jacky Achievements",
      subtitle:
        "Collectible Jacky badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Jacky session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Jacky more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Jacky sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Jacky is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Jacky Agent ☤",
    },
  },
