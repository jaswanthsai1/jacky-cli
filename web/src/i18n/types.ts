...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateJacky: string;
    updateJackyConfirmMessage?: string;
    updateJackyConfirmNow?: string;
    updateJackyConfirmTitle?: string;
    updatingJacky: string;
  ...
  // ── Achievements plugin (plugins/jacky-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
