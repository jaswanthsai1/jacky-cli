 ...
 *
 * Values mirror jacky_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Jacky default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Jacky' default when unset). */
