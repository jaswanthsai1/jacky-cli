 ...
 *
 * Plugins call window.__JACKY_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__JACKY_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__JACKY_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__JACKY_PLUGIN_SDK__ = {
    ...
    // window.__JACKY_SESSION_TOKEN__ directly.
    authedFetch,
