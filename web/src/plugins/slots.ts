 ...
 * `window.__JACKY_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Jacky brand in the top bar
 ...
 *  `window.__JACKY_PLUGINS__.registerSlot(...)`.
 *
