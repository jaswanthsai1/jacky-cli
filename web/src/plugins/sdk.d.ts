/**
 * Jacky Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__JACKY_PLUGIN_SDK__`` and
 * ``window.__JACKY_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__JACKY_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``JackyPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@jacky/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__JACKY_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__JACKY_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__JACKY_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface JackyPluginSDK {
...
declare global {
  interface Window {
    __JACKY_PLUGIN_SDK__?: JackyPluginSDK;
    __JACKY_PLUGINS__?: PluginRegistry;
  }
}
