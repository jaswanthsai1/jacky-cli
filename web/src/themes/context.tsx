...
const STORAGE_KEY = "jacky-dashboard-theme";
...
const FONT_STORAGE_KEY = "jacky-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `jacky_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "jacky-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-jacky-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-jacky-theme-font", "true");
