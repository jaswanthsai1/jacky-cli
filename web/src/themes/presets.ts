 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `jacky_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Jacky Teal",
  description: "Classic dark teal — the canonical Jacky look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Jacky Teal (Large)",
  description: "Jacky Teal with bigger fonts and roomier spacing",
