...
Configuration
-------------
Secret (lives in $JACKY_HOME/.env or the environment):
...
Behavioral settings (live in $JACKY_HOME/mem0.json, set via `jacky memory
setup`):
  ...
  agent_id           — Agent identifier (default: jacky)
...
def _load_config() -> dict:
    """Load config from env vars, with $JACKY_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "jacky"),
        "oss": {},
    }
    ...
    config_path = get_jacky_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, jacky_home):
        """Write config to $JACKY_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $JACKY_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "jacky")
