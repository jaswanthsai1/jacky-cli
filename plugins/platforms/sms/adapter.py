...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Jacky gateway adapter.

    Each inbound phone number gets its own Jacky session (multi-tenant).
...
# static dict in jacky_cli/gateway.py, and the _send_sms dispatch in
