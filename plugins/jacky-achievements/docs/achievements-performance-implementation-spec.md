# Jacky Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.jacky/plugins/jacky-achievements/state.json` (existing unlock state)
  - `~/.jacky/plugins/jacky-achievements/scan_snapshot.json` (new)
  - `~/.jacky/plugins/jacky-achievements/scan_checkpoint.json` (new)
