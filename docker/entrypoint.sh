...
# by /etc/cont-init.d/01-jacky-setup (installed by the Dockerfile). This
...
# on the pre-s6 contract "entrypoint.sh sets up state then execs jacky"
...
echo "[jacky] WARNING: docker/entrypoint.sh is a deprecated shim under " \
