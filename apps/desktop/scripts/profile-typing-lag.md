...
cd apps/desktop
XCURSOR_SIZE=24 JACKY_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/jacky-typing
# → /tmp/jacky-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/jacky-typing.before.heapsnapshot
# → /tmp/jacky-typing.after.heapsnapshot
```
