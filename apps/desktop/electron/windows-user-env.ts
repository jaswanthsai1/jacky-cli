...
// even though a fresh shell — and the Jacky CLI — sees it immediately. The
// desktop's JACKY_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\jacky. Reading
...
//       JACKY_HOME    REG_SZ    F:\Jacky\data
//
