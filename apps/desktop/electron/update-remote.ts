 ...
 *
 * A public install can end up with `origin=git@github.com:jaswanthsai1/jacky-cli.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/jaswanthsai1/jacky-cli.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/jaswanthsai1/jacky-cli'
