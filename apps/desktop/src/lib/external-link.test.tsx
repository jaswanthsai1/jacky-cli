...
const desktopWindow = window as unknown as { jackyDesktop?: Window['jackyDesktop'] }
const initialJackyDesktop = desktopWindow.jackyDesktop

function installDesktopBridge(partial: Partial<Window['jackyDesktop']> = {}) {
  desktopWindow.jackyDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['jackyDesktop']
}
...
afterEach(() => {
  ...
  if (initialJackyDesktop) {
    desktopWindow.jackyDesktop = initialJackyDesktop
  } else {
    delete desktopWindow.jackyDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['jackyDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['jackyDesktop']['openExternal'] })
