...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|jacky):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.jackyDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.jackyDesktop?.openExternal?.(href)
  }
}
