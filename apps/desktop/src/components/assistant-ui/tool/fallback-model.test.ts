  ...
  it('shows failed title when navigate returns success=false', () => {
    const view = buildToolView(
      part({
        ...
        args: { url: 'https://jaswanthsai1.github.io/jacky-cli' },
    ...
    expect(view.title).toBe('Failed to open jaswanthsai1.github.io')
  })
  ...
  it('shows opened title on success', () => {
    const view = buildToolView(
      part({
        toolName: 'browser_navigate',
        args: { url: 'https://jaswanthsai1.github.io/jacky-cli' },
        result: { success: true, url: 'https://jaswanthsai1.github.io/jacky-cli', title: 'Docs' }
      }),
      ''
    )

    expect(view.status).toBe('success')
    expect(view.title).toBe('Opened jaswanthsai1.github.io')
  })
})
