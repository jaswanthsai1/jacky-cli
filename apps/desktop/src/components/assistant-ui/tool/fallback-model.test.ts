  ...
  it('shows failed title when navigate returns success=false', () => {
    const view = buildToolView(
      part({
        ...
        args: { url: 'https://jacky-agent.nousresearch.com/docs' },
    ...
    expect(view.title).toBe('Failed to open jacky-agent.nousresearch.com')
  })
  ...
  it('shows opened title on success', () => {
    const view = buildToolView(
      part({
        toolName: 'browser_navigate',
        args: { url: 'https://jacky-agent.nousresearch.com/docs' },
        result: { success: true, url: 'https://jacky-agent.nousresearch.com/docs', title: 'Docs' }
      }),
      ''
    )

    expect(view.status).toBe('success')
    expect(view.title).toBe('Opened jacky-agent.nousresearch.com')
  })
})
