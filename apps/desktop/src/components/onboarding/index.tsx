...
import { getGlobalModelOptions } from '@/jacky'
...
import type { ModelOptionProvider, OAuthProvider } from '@/types/jacky'
...
const API_KEY_OPTIONS: ApiKeyOption[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://github.com/jaswanthsai1/jacky-cli#bring-your-own-endpoint',
    placeholder: 'http://127.0.0.1:8000/v1'
  }
]

// Build the FULL API-key provider catalog from the backend model options so the
// onboarding / Providers key form lists every `api_key` provider `jacky model`
...
const SHOW_ALL_KEY = 'jacky-onboarding-show-all-v1'
