...
export const en: Translations = {
  ...
  boot: {
    ready: 'Jacky Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Jacky settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingJackyDesktop: 'Starting Jacky Desktop…'
    },
    errors: {
      backgroundExited: 'Jacky background process exited.',
      backgroundExitedDuringStartup: 'Jacky background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Jacky backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateJacky: 'Update Jacky',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Jacky Desktop.',
    ...
    native: {
      ...
      inputBody: 'Jacky is waiting for your response.',
      turnDoneTitle: 'Jacky finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Jacky defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Jacky is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Jacky asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Jacky was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Jacky follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Jacky is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Jacky, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Jacky checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Jacky configuration...',
    ...
    gateway: {
      ...
      intro:
        'Jacky Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Jacky backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset JACKY_DESKTOP_REMOTE_URL and JACKY_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Jacky backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Jacky backend.',
      remoteAuthHint:
        'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Jacky Cloud',
      cloudDesc: 'Sign in once to Jacky Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Jacky Cloud',
      cloudSignIn: 'Sign in to Jacky Cloud',
      cloudSignedIn: 'Signed in to Jacky Cloud',
      cloudNeedsSignIn: 'Sign in to Jacky Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Jacky Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Jacky Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Jacky Cloud',
      cloudSignedOutMessage: 'Cleared the Jacky Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /jacky.',
      ...
      restartingMessage: 'Jacky Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Jacky ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Jacky runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via jacky curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Jacky builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Jacky to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Jacky to generate pets.',
      backgroundHint: 'You can close this — Jacky will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Jacky desktop' },
    ...
    jackyActiveSessions: (version, count) => `Jacky ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@jacky:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Jacky environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Jacky will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Jacky backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Jacky. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Jacky...',
    placeholderReconnecting: 'Reconnecting to Jacky…',
    ...
    attachUrlDesc: 'Jacky will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Jacky to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Jacky…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Jacky…',
    ...
    unsupportedMessage: 'This version of Jacky can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Jacky from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Jacky will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Jacky desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Jacky updater takes over in its own window and reopens Jacky automatically when it’s done. Please don’t reopen Jacky yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Jacky reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Jacky reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Jacky needs a one-time install',
    ...
    settingUpTitle: 'Setting up Jacky Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Jacky CLI or desktop instance is running. Stop any running Jacky instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Jacky Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Jacky is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Jacky…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Jacky',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Jacky at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Jacky connects automatically',
    ...
    authorizeThere: 'Authorize Jacky there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Jacky there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Jacky Desktop v${version}`,
      ...
      gatewayTitle: 'Jacky inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Jacky will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Jacky is restarting...',
      askRestart: 'Ask Jacky to restart the server',
      lookingRestart: taskId => `Jacky is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Jacky is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Jacky finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Jacky could not restart the server.',
      stillWorking:
        'Jacky is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Jacky is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Jacky gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.jacky/config.yaml). Jacky won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Jacky needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Jacky needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Jacky Desktop to use Save Image.',
    restartToSaveImages: 'Restart Jacky Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `jacky gateway` running?'
    }
  },
