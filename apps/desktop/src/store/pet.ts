...
export interface PetInfo {
  ...
  // the Jacky "run" activity state uses the in-place running row).
 ...
 * JACKY_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'jacky.desktop.pet-roam.v1'
