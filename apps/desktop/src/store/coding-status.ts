...
import type { JackyGitWorktree, JackyRepoStatus } from '@/global'
...
export const $repoStatus = atom<JackyRepoStatus | null>(null)
...
export const $repoWorktrees = atom<JackyGitWorktree[]>([])
