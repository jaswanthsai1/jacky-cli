...
import { getJackyConfigRecord, listAllProfileSessions } from '@/jacky'
...
// Jacky session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          },
          {
            icon: Download,
            id: 'cc-update-jacky',
            keywords: ['update', 'upgrade', 'jacky', 'version', 'system', 'restart'],
            label: cc.updateJacky,
