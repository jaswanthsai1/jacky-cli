...
const FOCUS_EVENT = 'jacky:composer-focus'
const INSERT_EVENT = 'jacky:composer-insert'
const INSERT_REFS_EVENT = 'jacky:composer-insert-refs'
const SUBMIT_EVENT = 'jacky:composer-submit'
const VOICE_TOGGLE_EVENT = 'jacky:composer-voice-toggle'
