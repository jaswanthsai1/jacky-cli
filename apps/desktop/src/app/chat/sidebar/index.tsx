...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/jacky'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('jacky:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('jacky:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Jacky to
