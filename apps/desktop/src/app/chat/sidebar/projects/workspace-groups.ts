...
import type { ProjectInfo, SessionInfo } from '@/jacky'
 ...
 * repo shows its branches/worktrees even when they have no Jacky sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: JackyGitWorktree[]
): SidebarSessionGroup[] {
