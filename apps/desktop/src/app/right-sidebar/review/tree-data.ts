import type { JackyReviewFile } from '@/global'
...
export function buildReviewFlatList(files: JackyReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: JackyReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
