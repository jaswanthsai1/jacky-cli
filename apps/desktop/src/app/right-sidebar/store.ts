...
const TAKEOVER_KEY = 'jacky.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Jacky can't clear via the API — the user
 *  sees exactly what runs instead of Jacky silently deleting their creds. */
