...
import { getActionStatus, getComputerUseStatus, grantComputerUsePermissions } from '@/jacky'
import { AlertTriangle, Check, ExternalLink, Loader2, RefreshCw, X } from '@/lib/icons'
import { upsertDesktopActionTask } from '@/store/activity'
import { notify, notifyError } from '@/store/notifications'
import type { ComputerUseStatus } from '@/types/jacky'
 ...
 * cua-driver's own `com.trycua.driver` identity — not Jacky — and are
        ...
        <div className="min-w-0">
          {status.can_grant ? (
            <p className="text-[0.72rem] text-muted-foreground">
              Grants attach to CuaDriver&apos;s own identity (com.trycua.driver), not Jacky — so the dialog is
