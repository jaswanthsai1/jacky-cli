...
describe('settings helpers', () => {
  ...
  it('reads and writes nested config paths', () => {
    const config: JackyConfigRecord = { display: { theme: 'mono' } }
  ...
  it('rejects prototype-polluting config paths', () => {
    const config: JackyConfigRecord = {}
  ...
  describe('providerGroup', () => {
    ...
    it('prefers the longest matching prefix so CN/regional buckets win', () => {
      ...
      // JACKY_QWEN_ shares the JACKY_ stem with other integrations.
      expect(providerGroup('JACKY_QWEN_BASE_URL')).toBe('DashScope (Qwen)')
