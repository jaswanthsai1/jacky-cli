...
import type { JackyConfigRecord, ToolsetInfo } from '@/types/jacky'
...
export function getNested(obj: JackyConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: JackyConfigRecord, path: string, value: unknown): JackyConfigRecord {
...
function personalityOptions(config: JackyConfigRecord): string[] {
