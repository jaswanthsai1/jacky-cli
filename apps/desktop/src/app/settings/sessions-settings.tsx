...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/jacky'
...
// / Program Files), which buried any files Jacky wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.jackyDesktop` is
    ...
    const settings = window.jackyDesktop?.settings
