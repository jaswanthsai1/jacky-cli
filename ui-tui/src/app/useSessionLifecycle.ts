...
import type { ScrollBoxHandle } from '@jacky/ink'
import { evictInkCaches } from '@jacky/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.JACKY_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
