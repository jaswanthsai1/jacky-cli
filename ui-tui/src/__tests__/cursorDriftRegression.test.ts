 ...
 *
 * Symptom: in `jacky --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@jacky/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using jacky --tui and as i type multiline my caret at the end will often ' +
