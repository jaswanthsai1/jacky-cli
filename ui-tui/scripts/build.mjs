...
await build({
  ...
  // Skip the prebuilt @jacky/ink bundle and inline the source instead:
  ...
  alias: { '@jacky/ink': resolve(root, 'packages/jacky-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The jacky_cli launcher
