...
Uses a throwaway JACKY_HOME so it never touches ~/.jacky. No real names.
"""
...
def _fresh_home():
    """Point JACKY_HOME at a throwaway dir BEFORE importing gateway modules
    (mirror.py binds _SESSIONS_INDEX from get_jacky_home() at import time)."""
...
# Import AFTER JACKY_HOME is set.
...
# a different get_jacky_home() at import if something imported it earlier).
...
def main():
    ...
    print(f"JACKY_HOME (throwaway): {HOME}")
