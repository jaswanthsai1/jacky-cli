    ...
    with patch.dict("sys.modules", {
        ...
        with patch("subprocess.Popen") as mock_popen:
            ...
            worker = _SlashWorker(
                ...
                model="test-model",
                profile_home="/home/luke/.jacky/profiles/work"
            )
            
            # Verify Popen was called
            assert mock_popen.called
            
            # Check that JACKY_HOME was set in the environment
            call_kwargs = mock_popen.call_args[1]
            assert "env" in call_kwargs
            assert call_kwargs["env"]["JACKY_HOME"] == "/home/luke/.jacky/profiles/work"
...
def test_slash_worker_without_profile_home():
    ...
    with patch.dict("sys.modules", {
        ...
        with patch("subprocess.Popen") as mock_popen:
            ...
            # Check that JACKY_HOME was NOT overridden
            call_kwargs = mock_popen.call_args[1]
            assert "env" in call_kwargs
            # JACKY_HOME should be from parent env or undefined (inherited from os.environ)
...
def test_slash_worker_with_none_profile_home():
    ...
    with patch.dict("sys.modules", {
        ...
        with patch("subprocess.Popen") as mock_popen:
            ...
            # Check that JACKY_HOME was NOT set
            call_kwargs = mock_popen.call_args[1]
            env = call_kwargs["env"]
            # When profile_home is None, JACKY_HOME should come from parent env only
            if "JACKY_HOME" in env:
