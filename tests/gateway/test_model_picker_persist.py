...
closure the PR changed, against a real temp ``JACKY_HOME``.
"""
...
def _setup_isolated_home(tmp_path, monkeypatch, model_yaml_value):
    ...
    monkeypatch.setattr(
        "jacky_cli.model_switch.resolve_display_context_length",
        lambda *a, **k: 272000,
    )
