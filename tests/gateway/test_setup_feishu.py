"""Tests for _setup_feishu() in jacky_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("jacky_cli.config.save_env_value", side_effect=mock_save), \
         patch("jacky_cli.config.get_env_value", side_effect=mock_get), \
         patch("jacky_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("jacky_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("jacky_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("jacky_cli.cli_output.print_header"), \
         patch("jacky_cli.cli_output.print_info"), \
         patch("jacky_cli.cli_output.print_success"), \
         patch("jacky_cli.cli_output.print_warning"), \
         patch("jacky_cli.cli_output.print_error"), \
