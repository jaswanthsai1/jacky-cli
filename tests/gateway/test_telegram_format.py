...
async def test_legacy_send_keeps_chunk_indicators_outside_fenced_code_lines(adapter):
    ...
    content = (
        ...
        "```text\n"
        + ("~/.jacky/skills/github/jacky-contribution-workflow/SKILL.md\n" * 8)
        + "```\n"
        "After."
    )
...
def _guest_mention_entity(text, mention="@jacky_bot"):
