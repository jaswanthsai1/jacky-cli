...
class TestTelegramYamlConfigLoading:
    ...
    def _write_config(self, tmp_path, content: str):
        ...
        jacky_home.mkdir()
        (jacky_home / "config.yaml").write_text(content, encoding="utf-8")
        return jacky_home
    ...
    def test_top_level_reply_to_mode_off(self, tmp_path, monkeypatch):
        ...
        jacky_home = self._write_config(tmp_path, "telegram:\n  reply_to_mode: off\n")
...
class TestDMTopicFallbackReplyToMode:
    ...
    Regression tests for https://github.com/jaswanthsai1/jacky-cli/issues/23994:
    reply_to_mode 'off' was ignored when sending via Jacky-created DM topic
