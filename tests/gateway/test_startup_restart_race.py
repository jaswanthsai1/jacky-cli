...
def patch_startup_side_effects(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("jacky_cli.plugins.discover_plugins", lambda: None)
...
async def test_start_gateway_does_not_start_cron_after_aborted_startup(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("jacky_cli.jacky_logging.setup_logging", lambda jacky_home, mode: None)
