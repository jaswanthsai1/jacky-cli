...
class TestSaveConfigValueAtomic:
    ...
    def config_env(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("jacky_cli.cli._jacky_home", jacky_home)
        return config_path
    ...
    def test_calls_roundtrip_yaml_update(self, config_env, monkeypatch):
        ...
        monkeypatch.setattr("jacky_cli.utils.atomic_roundtrip_yaml_update", mock_update)
    ...
    def test_file_not_truncated_on_error(self, config_env, monkeypatch):
        ...
        monkeypatch.setattr("jacky_cli.utils.atomic_roundtrip_yaml_update", exploding_write)
