"""Tests for JackyCLI initialization -- catches configuration bugs
...
def _make_cli(env_overrides=None, config_overrides=None, **kwargs):
    ...
    clean_env = {"LLM_MODEL": "", "JACKY_MAX_ITERATIONS": ""}
    if env_overrides:
    ...
    with patch.dict(sys.modules, prompt_toolkit_stubs), \
        ...
        with patch.object(_cli_mod, "get_tool_definitions", return_value=[]), \
            ...
            return _cli_mod.JackyCLI(**kwargs)
...
class TestMaxTurnsResolution:
    ...
    def test_env_var_max_turns(self):
        ...
        cli_obj = _make_cli(env_overrides={"JACKY_MAX_ITERATIONS": "42"})
        assert cli_obj.max_turns == 42

    def test_invalid_env_var_max_turns_falls_back_to_default(self):
        """Invalid env values should not crash CLI init."""
        cli_obj = _make_cli(env_overrides={"JACKY_MAX_ITERATIONS": "not-a-number"})
...
class TestPromptToolkitTerminalCompatibility:
    def test_lf_enter_binds_to_submit_handler_posix(self):
        ...
        from jacky_cli.cli import _bind_prompt_submit_keys
    ...
    def test_cpr_warning_callback_is_disabled(self):
        from jacky_cli.cli import _disable_prompt_toolkit_cpr_warning
    ...
    def test_cpr_disabled_output_marks_renderer_not_supported(self):
        ...
        """
        import sys as _sys
        from jacky_cli.cli import _build_cpr_disabled_output
    ...
    def test_cpr_gating_local_vs_tunnel(self, monkeypatch):
        ...
        """
        from jacky_cli.cli import _terminal_may_leak_cpr
...
class TestHistoryDisplay:
    ...
    def test_history_shows_recent_sessions_when_current_chat_is_empty(self, capsys):
        ...
        cli._session_db.list_sessions_rich.return_value = [
            ...
            },
            {
                ...
                "title": "Checking Running Jacky Agent",
                "preview": "check running gateways for jacky agent",
                "last_active": 0,
            },
        ]
        ...
        assert "Checking Running Jacky Agent" in output
    ...
    def test_resume_updates_jacky_session_id_env_and_context(self, tmp_path):
        ...
        os.environ["JACKY_SESSION_ID"] = "current_session"
        _VAR_MAP["JACKY_SESSION_ID"].set("current_session")

        try:
            cli._handle_resume_command("/resume target_session")

            assert cli.session_id == "target_session"
            assert os.environ["JACKY_SESSION_ID"] == "target_session"
            assert get_session_env("JACKY_SESSION_ID") == "target_session"
        finally:
            cli._session_db.close()
            os.environ.pop("JACKY_SESSION_ID", None)
            _VAR_MAP["JACKY_SESSION_ID"].set(_UNSET)
    ...
    def test_sessions_with_target_delegates_to_resume(self):
        ...
        with patch.object(cli, "_handle_resume_command") as mock_resume:
            cli.process_command("/sessions Checking Running Jacky Agent")

        mock_resume.assert_called_once_with(
            "/resume Checking Running Jacky Agent"
        )
...
class TestRootLevelProviderOverride:
    ...
    def test_model_provider_wins_over_root_provider(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(cli, "_jacky_home", jacky_home)
    ...
    def test_normalize_model_name_save_roundtrip_migrates_key(self, tmp_path, monkeypatch):
        ...
        import jacky_cli.config as cfgmod
