...
from jacky_cli.cli import _render_final_assistant_content
...
def test_final_assistant_content_preserves_windows_hidden_dir_paths():
    renderable = _render_final_assistant_content(
        r"D:\Projects\SourceCode\jacky-agent\.ai\skills" + "\\"
    )

    output = _render_to_text(renderable)
    assert r"D:\Projects\SourceCode\jacky-agent\.ai\skills" + "\\" in output
