...
class TestCLIQuickCommands:
    """Test quick command dispatch in JackyCLI.process_command."""
    ...
    def test_exec_command_uses_chat_console_when_tui_is_live(self):
        ...
        with patch("jacky_cli.cli.ChatConsole", return_value=live_console):
            result = cli.process_command("/dn")
    ...
    def test_quick_command_takes_priority_over_skill_commands(self):
        ...
        with patch("jacky_cli.cli._skill_commands", {"/mygif": {"name": "gif-search"}}):
...
class TestGatewayQuickCommands:
    ...
    async def test_exec_command_output_is_redacted(self, monkeypatch):
        ...
        # Ensure redaction is active regardless of host JACKY_REDACT_SECRETS state
        # or test ordering
