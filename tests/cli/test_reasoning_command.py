...
class TestParseReasoningConfig(unittest.TestCase):
    ...
    def _parse(self, effort):
        from jacky_cli.cli import _parse_reasoning_config
...
class TestReasoningPreviewBuffering(unittest.TestCase):
    ...
    @patch("jacky_cli.cli._cprint")
    @patch("jacky_cli.cli.shutil.get_terminal_size", return_value=SimpleNamespace(columns=50))
    ...
    @patch("jacky_cli.cli.shutil.get_terminal_size", return_value=SimpleNamespace(columns=60))
