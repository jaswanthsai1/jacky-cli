...
class TestVisionCpuBurstCap:
    ...
    def test_resolver_defaults_to_host_cpus_no_ceiling(self):
        ...
        with (
            ...
            patch("jacky_cli.config.load_config", side_effect=Exception),
        ):
            os.environ.pop("JACKY_VISION_MAX_CONCURRENCY", None)
    ...
    def test_resolver_env_override(self):
        ...
        with patch.dict(os.environ, {"JACKY_VISION_MAX_CONCURRENCY": "16"}):
    ...
    def test_resolver_rejects_sub_one_override(self):
        ...
        with (
            patch.dict(os.environ, {"JACKY_VISION_MAX_CONCURRENCY": "0"}),
            patch("tools.vision_tools._detect_host_cpus", return_value=2),
            patch("jacky_cli.config.load_config", side_effect=Exception),
        ):
