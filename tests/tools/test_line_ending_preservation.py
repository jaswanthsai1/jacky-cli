...
@pytest.fixture
def jacky_home(monkeypatch, tmp_path):
    """Isolate JACKY_HOME so the tests don't pollute the real config.
...
class TestPatchCRLFPreservation:
    def test_patch_on_crlf_file_stays_pure_crlf(self, jacky_home, tmp_path):
    ...
    def test_patch_on_lf_file_stays_lf(self, jacky_home, tmp_path):
    ...
    def test_patch_multiline_replacement_on_crlf(self, jacky_home, tmp_path):
...
class TestWriteFileCRLFPreservation:
    ...
    def test_new_file_written_as_is(self, jacky_home, tmp_path):
    ...
    def test_overwrite_lf_file_stays_lf(self, jacky_home, tmp_path):
