...
def _reset_backend():
    ...
    with patch.dict(os.environ, {"JACKY_COMPUTER_USE_BACKEND": "noop"}, clear=False):
        yield
    reset_backend_for_tests()
...
class TestCuaEnvironmentScrubbing:
    ...
    def test_cua_session_sanitizes_provider_env_vars(self):
        ...
        The cua-driver MCP subprocess should not inherit Jacky-managed
...
class TestClickButtonPassthrough:
    """Surface 5 (jaswanthsai1/jacky-cli#47072) — `middle_click` must
...
class TestImageMimeTypePropagation:
    """Surface 7 (jaswanthsai1/jacky-cli#47072): trycua/cua#1961 made
...
class TestMcpInvocationResolution:
    """Surface 8 (jaswanthsai1/jacky-cli#47072): instead of hardcoding
    ...
    the MCP subcommand doesn't require a Jacky patch.
    ...
    def test_future_renamed_subcommand_is_honored(self):
        ...
        instead of `mcp` keeps working without a Jacky patch."""
        from unittest.mock import patch
        from tools.computer_use.cua_backend import _resolve_mcp_invocation
    ...
    def test_falls_back_when_manifest_missing_command(self):
        ...
        resolved driver path (so JACKY_CUA_DRIVER_CMD still wins)."""
        from unittest.mock import patch
        from tools.computer_use.cua_backend import _resolve_mcp_invocation
...
class TestStructuredElementsConsumption:
    """Surface 2 (jaswanthsai1/jacky-cli#47072): trycua/cua#1961 made
...
class TestCapabilityDiscovery:
    """Surface 4 (jaswanthsai1/jacky-cli#47072): the wrapper learns
...
class TestElementTokenAttachment:
    """Surface 6 (jaswanthsai1/jacky-cli#47072): trycua/cua#1961 added
...
class TestSessionLifecycle:
    """Surface gap (audit June 2026): Jacky never declared a cua-driver
    ...
    def test_session_id_unique_per_backend(self):
        ...
        assert a != b, "each Jacky run should mint its own session id"
