"""Regression tests for JACKY_HOME override propagation onto the MCP loop.
...
get_jacky_home() inside the coroutine, most visibly OAuth token-store
...
def test_oauth_token_paths_follow_override(tmp_path, monkeypatch, mcp_loop):
    ...
    async def token_path():
        ...
        return str(JackyTokenStorage("probe-srv")._tokens_path())
