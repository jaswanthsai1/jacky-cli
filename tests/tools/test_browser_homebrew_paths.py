...
class TestRunBrowserCommandPathConstruction:
    ...
    def test_subprocess_preserves_executable_path_with_spaces(self, tmp_path):
        ...
        browser_path = "/Users/test/Library/Application Support/jacky/node_modules/.bin/agent-browser"
        jacky_home = str(tmp_path / "jacky-home")
 ...
 patch("tools.browser_tool._chromium_installed", return_value=True), \
             ...
             patch("jacky_cli.jacky_constants.Path.home", return_value=tmp_path), \
