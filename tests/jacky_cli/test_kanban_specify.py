"""Tests for the specifier module + `jacky kanban specify` CLI surface.
...
from jacky_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `jacky kanban …` argparse surface directly."""
