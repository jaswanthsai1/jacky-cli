...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (JACKY_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via JACKY_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in JACKY_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from jacky_cli.providers import JACKY_OVERLAYS
        assert "bedrock" in JACKY_OVERLAYS

    def test_bedrock_overlay_transport(self):
        from jacky_cli.providers import JACKY_OVERLAYS
        assert JACKY_OVERLAYS["bedrock"].transport == "bedrock_converse"

    def test_bedrock_overlay_auth_type(self):
        from jacky_cli.providers import JACKY_OVERLAYS
        assert JACKY_OVERLAYS["bedrock"].auth_type == "aws_sdk"
