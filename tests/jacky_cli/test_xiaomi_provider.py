...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from jacky_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in JACKY_OVERLAYS
        overlay = JACKY_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify jacky doctor recognizes Xiaomi env vars."""
