"""Tests for jacky_cli/goals.py — persistent cross-turn goals."""
...
def jacky_home(tmp_path, monkeypatch):
    """Isolated JACKY_HOME so SessionDB.state_meta writes don't clobber the real one."""
    ...
    # Bust the goal-module's DB cache for each test so it re-resolves JACKY_HOME.
    from jacky_cli import goals
...
class TestParseJudgeResponse:
    def test_clean_json_done(self):
        from jacky_cli.goals import _parse_judge_response
...
class TestJudgeGoal:
    def test_empty_goal_skipped(self):
        from jacky_cli.goals import judge_goal
...
class TestGoalManager:
    def test_no_goal_initial(self, jacky_home):
    ...
    def test_set_then_status(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_set_rejects_empty(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_pause_and_resume(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_clear(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_persistence_across_managers(self, jacky_home):
    ...
    def test_evaluate_after_turn_done(self, jacky_home):
    ...
    def test_evaluate_after_turn_continue_under_budget(self, jacky_home):
        from jacky_cli import goals
        from jacky_cli.goals import GoalManager
    ...
    def test_evaluate_after_turn_budget_exhausted(self, jacky_home):
    ...
    def test_evaluate_after_turn_inactive(self, jacky_home):
    ...
    def test_continuation_prompt_shape(self, jacky_home):
        ...
        mgr.set("port goal command to jacky")
        prompt = mgr.next_continuation_prompt()
        assert prompt is not None
        assert "port goal command to jacky" in prompt
...
def test_goal_command_dispatches_in_cli_registry_helpers():
    ...
    from jacky_cli.commands import COMMANDS, COMMANDS_BY_CATEGORY
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_auto_pause_after_three_consecutive_parse_failures(self, jacky_home):
        """N=3 consecutive parse failures → auto-pause with config pointer."""
        from jacky_cli import goals
        from jacky_cli.goals import GoalManager, DEFAULT_MAX_CONSECUTIVE_PARSE_FAILURES
    ...
    def test_parse_failure_counter_resets_on_good_reply(self, jacky_home):
    ...
    def test_parse_failure_counter_not_incremented_by_api_errors(self, jacky_home):
    ...
    def test_consecutive_parse_failures_persists_across_goalmanager_reloads(
        ...
        from jacky_cli import goals
        from jacky_cli.goals import GoalManager, load_goal
...
class TestGoalStateSubgoalsBackcompat:
    def test_old_state_meta_row_loads_without_subgoals(self):
        ...
        from jacky_cli.goals import GoalState
...
class TestMigrateGoalToSession:
    ...
    def test_migrates_active_goal_to_child(self, jacky_home):
        from jacky_cli.goals import save_goal, load_goal, migrate_goal_to_session, GoalState
    ...
    def test_no_goal_to_migrate_returns_false(self, jacky_home):
        from jacky_cli.goals import migrate_goal_to_session, load_goal
        assert migrate_goal_to_session("empty-parent", "child2") is False
        assert load_goal("child2") is None

    def test_does_not_clobber_existing_child_goal(self, jacky_home):
        from jacky_cli.goals import save_goal, load_goal, migrate_goal_to_session, GoalState
    ...
    def test_same_id_is_noop(self, jacky_home):
        from jacky_cli.goals import save_goal, migrate_goal_to_session, GoalState
        save_goal("same", GoalState(goal="g"))
        assert migrate_goal_to_session("same", "same") is False

    def test_cleared_goal_not_migrated(self, jacky_home):
        from jacky_cli.goals import save_goal, clear_goal, migrate_goal_to_session, load_goal, GoalState
...
class TestGoalManagerSubgoals:
    def test_add_subgoal(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_add_subgoal_requires_active_goal(self, jacky_home):
        import pytest
        from jacky_cli.goals import GoalManager
    ...
    def test_add_empty_subgoal_rejected(self, jacky_home):
        import pytest
        from jacky_cli.goals import GoalManager
    ...
    def test_remove_subgoal(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_remove_subgoal_out_of_range(self, jacky_home):
        import pytest
        from jacky_cli.goals import GoalManager
    ...
    def test_clear_subgoals(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_subgoals_persist_across_reloads(self, jacky_home):
...
class TestContinuationPromptWithSubgoals:
    def test_empty_subgoals_uses_original_template(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_with_subgoals_includes_them(self, jacky_home):
        from jacky_cli.goals import GoalManager
...
class TestJudgeGoalWithSubgoals:
    def test_judge_uses_subgoals_template_when_provided(self, jacky_home):
    ...
    def test_judge_uses_original_template_when_no_subgoals(self, jacky_home):
        from unittest.mock import patch
        from jacky_cli import goals
...
class TestStatusLineSubgoalCount:
    def test_status_line_no_subgoals(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_status_line_with_subgoals(self, jacky_home):
        from jacky_cli.goals import GoalManager
...
class TestWaitBarrier:
    ...
    def test_wait_on_requires_active_goal(self, jacky_home):
        from jacky_cli.goals import GoalManager
        mgr = GoalManager(session_id="wb-noactive")
        with pytest.raises(RuntimeError):
            mgr.wait_on(12345)

    def test_wait_on_rejects_bad_pid(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_parked_on_live_pid_does_not_continue_or_judge(self, jacky_home):
        from jacky_cli import goals
        from jacky_cli.goals import GoalManager
    ...
    def test_barrier_auto_clears_when_process_exits_and_loop_resumes(self, jacky_home):
        from jacky_cli import goals
        from jacky_cli.goals import GoalManager
    ...
    def test_dead_pid_never_parks(self, jacky_home):
        from jacky_cli import goals
        from jacky_cli.goals import GoalManager
    ...
    def test_stop_waiting_clears_barrier(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_pause_and_resume_clear_barrier(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_barrier_persists_and_reloads(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_old_state_row_loads_without_barrier_fields(self, jacky_home):
...
class TestJudgeDrivenWait:
    ...
    def test_judge_wait_pid_parks_loop(self, jacky_home):
        from jacky_cli import goals
        from jacky_cli.goals import GoalManager
    ...
    def test_judge_wait_seconds_parks_loop(self, jacky_home):
        from jacky_cli import goals
        from jacky_cli.goals import GoalManager
    ...
    def test_time_barrier_clears_after_deadline(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_continue_verdict_still_continues_with_background(self, jacky_home):
...
class TestSessionTriggerBarrier:
    ...
    def test_registry_is_session_waiting_running_unmatched(self, jacky_home):
        s, reg = self._inject("proc_t1", watch_patterns=["READY"])
        assert reg.is_session_waiting("proc_t1") is True

    def test_registry_releases_on_watch_match_while_alive(self, jacky_home):
    ...
    def test_registry_releases_on_exit_plain_session(self, jacky_home):
    ...
    def test_registry_unknown_session_never_waits(self, jacky_home):
        from tools.process_registry import process_registry
        assert process_registry.is_session_waiting("proc_does_not_exist") is False

    def test_goal_parks_on_session_and_releases_on_trigger(self, jacky_home):
        from jacky_cli import goals
        from jacky_cli.goals import GoalManager
    ...
    def test_wait_on_session_validation(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_session_directive_parsed_from_judge(self, jacky_home):
        from jacky_cli.goals import _parse_judge_response
    ...
    def test_old_state_loads_without_session_field(self, jacky_home):
        from jacky_cli.goals import GoalState
...
class TestParseContract:
    def test_plain_goal_no_contract(self):
        from jacky_cli.goals import parse_contract
...
class TestGoalContractSerialization:
    def test_roundtrip_with_contract(self):
        from jacky_cli.goals import GoalState, GoalContract
    ...
    def test_render_block_omits_empty_fields(self):
        from jacky_cli.goals import GoalContract
...
class TestGoalManagerContract:
    def test_set_with_contract(self, jacky_home):
        from jacky_cli.goals import GoalManager, GoalContract
    ...
    def test_set_without_contract_no_marker(self, jacky_home):
        from jacky_cli.goals import GoalManager
    ...
    def test_continuation_prompt_includes_contract(self, jacky_home):
        from jacky_cli.goals import GoalManager, GoalContract
    ...
    def test_set_contract_after_the_fact(self, jacky_home):
        from jacky_cli.goals import GoalManager, GoalContract
        ...
        assert mgr.has_contract()
        # Survives reload.
        from jacky_cli.goals import GoalManager as GM2
        assert GM2(session_id="c-after").has_contract()

    def test_persistence_roundtrip(self, jacky_home):
        from jacky_cli.goals import GoalManager, GoalContract
...
class TestJudgeWithContract:
    ...
    def test_judge_uses_contract_template(self, jacky_home):
        from unittest.mock import patch
        from jacky_cli import goals
        from jacky_cli.goals import GoalContract
    ...
    def test_contract_plus_subgoals_combine(self, jacky_home):
        from unittest.mock import patch
        from jacky_cli import goals
        from jacky_cli.goals import GoalContract
...
class TestDraftContract:
    def test_draft_parses_json(self, jacky_home):
        from unittest.mock import patch
        from jacky_cli import goals
    ...
    def test_draft_returns_none_on_bad_json(self, jacky_home):
        from unittest.mock import patch
        from jacky_cli import goals
    ...
    def test_draft_returns_none_when_no_client(self, jacky_home):
        from unittest.mock import patch
        from jacky_cli import goals
...
class TestContractAndBackgroundCompose:
    ...
    def test_judge_prompt_carries_contract_and_background(self, jacky_home):
        from unittest.mock import patch
        from jacky_cli import goals
        from jacky_cli.goals import GoalContract
    ...
    def test_contract_goal_can_still_complete_on_evidence(self, jacky_home):
        from unittest.mock import patch
        from jacky_cli import goals
        from jacky_cli.goals import GoalContract
