"""Tests for jacky_cli.status model/provider display."""

from types import SimpleNamespace

from jacky_cli.nous_account import NousPaidServiceAccessInfo, NousPortalAccountInfo
...
def test_show_status_reports_managed_nous_features(monkeypatch, capsys, tmp_path):
    monkeypatch.setattr("jacky_cli.status.managed_nous_tools_enabled", lambda: True)
    from jacky_cli import status as status_mod
...
def test_show_status_hides_nous_subscription_section_when_feature_flag_is_off(monkeypatch, capsys, tmp_path):
    monkeypatch.setattr("jacky_cli.status.managed_nous_tools_enabled", lambda: False)
    from jacky_cli import status as status_mod
...
def test_show_status_reports_empty_lmstudio_listing_as_reachable(monkeypatch, capsys, tmp_path):
    ...
    monkeypatch.setattr(
        "jacky_cli.models.probe_lmstudio_models",
