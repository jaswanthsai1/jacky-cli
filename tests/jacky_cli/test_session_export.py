...
from jacky_cli.session_export import export_record_count, render_sessions_export
...
def test_sessions_export_cli_prompt_only_stdout(monkeypatch, capsys):
    ...
    monkeypatch.setattr(
        sys,
        "argv",
        ["jacky", "sessions", "export", "-", "--session-id", "sess", "--only", "user-prompts"],
    )
...
def test_sessions_export_only_rejects_unsupported_format(monkeypatch, capsys):
    ...
    monkeypatch.setattr(
        sys,
        "argv",
        ["jacky", "sessions", "export", "-", "--format", "html", "--only", "user-prompts"],
    )
