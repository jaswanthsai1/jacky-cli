...
class TestStatusEndpointTopology:
    ...
    def _setup_client(self, monkeypatch, _isolate_jacky_home):
        try:
    ...
    def test_profile_names_and_mode_public_when_auth_gated(self, monkeypatch):
        ...
        # Jacky Cloud Portal reads /api/status over the network (a gated bind)
        ...
        try:
            ...
            # alongside jacky_home / gateway_pid.
            assert "gateways" not in data
            assert "jacky_home" not in data
