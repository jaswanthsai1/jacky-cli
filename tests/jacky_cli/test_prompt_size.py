"""Tests for the ``jacky prompt-size`` diagnostic (issue #34667)."""
...
from jacky_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(jacky_home, memory_text="", user_text=""):
    mem_dir = jacky_home / "memories"
...
def _seed_skill(jacky_home, name, description):
    skill_dir = jacky_home / "skills" / "demo" / name
