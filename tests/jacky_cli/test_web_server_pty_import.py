"""Test the platform-branched PTY bridge import in jacky_cli.web_server.
...
def test_web_server_uses_win_pty_bridge_on_windows():
    ...
    from jacky_cli.win_pty_bridge import WinPtyBridge
    ...
    from jacky_cli.win_pty_bridge import PtyUnavailableError as WinErr
...
def test_web_server_uses_posix_pty_bridge_on_posix():
    ...
    from jacky_cli.pty_bridge import PtyBridge as PosixBridge
    from jacky_cli.pty_bridge import PtyUnavailableError as PosixErr
...
def test_pty_bridge_import_block_is_platform_branched():
    ...
    #       try:
    #           from jacky_cli.win_pty_bridge import WinPtyBridge as PtyBridge, ...
    #       except ImportError:
    #           PtyBridge = None
    #           ...
    #   else:
    ...
    assert "from jacky_cli.win_pty_bridge import" in src
    assert "from jacky_cli.pty_bridge import" in src
