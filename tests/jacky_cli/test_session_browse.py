"""Tests for the interactive session browser (`jacky sessions browse`).
...
from jacky_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """jacky sessions browse should be parseable."""
