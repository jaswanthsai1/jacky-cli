"""Tests for jacky_cli.azure_detect — transport & model auto-detection."""
...
def test_http_get_json_on_urlerror_returns_zero_none():
    ...
    import urllib.error
    with patch("jacky_cli.azure_detect.open_credentialed_url",
...
def test_http_get_json_on_http_error_returns_code_none():
    ...
    with patch("jacky_cli.azure_detect.open_credentialed_url", side_effect=err):
