...
def _parse_slack_args(argv):
    """Build the real `jacky slack` parser and parse argv against it."""
...
class TestSlackFullManifest:
    """Generated full Slack app manifest used by `jacky slack manifest`."""

    def test_app_home_messages_are_writable(self):
        manifest = _build_full_manifest("Jacky", "Your Jacky agent on Slack")
    ...
    def test_group_dm_surface_present_without_assistant_mode(self):
        ...
        manifest = _build_full_manifest(
            "Jacky", "Your Jacky agent on Slack", include_assistant=False
        )
