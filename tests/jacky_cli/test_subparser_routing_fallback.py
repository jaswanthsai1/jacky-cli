...
The main() function in jacky_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `jacky -c model`
...
def _build_parser():
    """Build a minimal replica of the jacky top-level parser."""
