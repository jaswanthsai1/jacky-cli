"""Tests for `jacky curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import jacky_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated JACKY_HOME with real agent-created skills on disk."""
    home = tmp_path / ".jacky"
    skills = home / "skills"
    ...
    from jacky_cli import curator as curator_cli
