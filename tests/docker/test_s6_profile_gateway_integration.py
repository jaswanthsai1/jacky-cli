...
The unit tests in tests/jacky_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned jacky-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/jacky")
from jacky_cli.service_manager import S6ServiceManager
