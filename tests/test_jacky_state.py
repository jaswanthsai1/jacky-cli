"""Tests for jacky_state.py — SessionDB SQLite CRUD, FTS5 search, export."""
...
class TestSchemaInit:
    ...
    def test_topic_mode_schema_is_not_auto_migrated_on_open(self, tmp_path):
        ...
        The gateway must remain rollback-safe: simply upgrading Jacky and starting
...
class TestApplyWalProbe:
    ...
    def test_macos_checkpoint_fullsync_barrier_applied(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(jacky_state.sys, "platform", "darwin")
    ...
    def test_checkpoint_fullsync_barrier_skipped_off_darwin(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(jacky_state.sys, "platform", "linux")
...
def test_refresh_compression_lock_requires_holder_and_preserves_reclaimability(db, monkeypatch):
    ...
    monkeypatch.setattr(jacky_state.time, "time", lambda: 1000.0)
    ...
    monkeypatch.setattr(jacky_state.time, "time", lambda: 1005.0)
    ...
    monkeypatch.setattr(jacky_state.time, "time", lambda: 1016.0)
