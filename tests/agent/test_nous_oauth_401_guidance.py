...
to a generic "Your API key was rejected... run jacky setup" message, which is
...
def test_nous_401_guidance_strings_present():
    ...
    # Must give a concrete re-auth command, not a generic "jacky setup".
    assert "jacky portal" in source
