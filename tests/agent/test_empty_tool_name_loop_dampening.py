...
@pytest.fixture()
def agent_env():
    """Spin up the mock provider + an isolated JACKY_HOME, yield (agent, helpers)."""
    ...
    test_home = tempfile.mkdtemp(prefix="jacky_e2e_47967_")
    os.makedirs(os.path.join(test_home, ".jacky"))
    prev_home = os.environ.get("JACKY_HOME")
    os.environ["JACKY_HOME"] = os.path.join(test_home, ".jacky")
    ...
    try:
        ...
        if prev_home is None:
            ...
            os.environ["JACKY_HOME"] = prev_home
