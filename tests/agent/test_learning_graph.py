...
def test_jacky_meta_tolerates_non_dict():
    assert learning_graph._jacky_meta({"metadata": "junk"}) == {}
    assert learning_graph._jacky_meta({"metadata": {"jacky": "junk"}}) == {}
    assert learning_graph._jacky_meta({"metadata": {"jacky": {"category": "x"}}}) == {"category": "x"}
