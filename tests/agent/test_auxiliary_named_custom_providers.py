...
def _isolate(tmp_path, monkeypatch):
    """Redirect JACKY_HOME and clear module caches."""
...
def _write_config(tmp_path, config_dict):
    """Write a config.yaml to the test JACKY_HOME."""
    import yaml
...
class TestResolveProviderClientMainAlias:
    ...
    def test_main_resolves_github_copilot_alias(self, tmp_path):
        ...
        with (
            patch("jacky_cli.auth.resolve_api_key_provider_credentials", return_value={
