...
thinking phase.  Jacky's default cloud-stream stale detector
(``JACKY_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``JACKY_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
