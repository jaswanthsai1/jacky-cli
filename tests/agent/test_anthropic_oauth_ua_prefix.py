...
class TestOAuthUserAgentPrefix:
    ...
    def test_token_exchange_ua_not_throttled(self):
        """run_jacky_oauth_login_pure must NOT send a throttled token-endpoint UA.
        ...
        try:
            source = inspect.getsource(mod.run_jacky_oauth_login_pure)
        except AttributeError:
            pytest.skip("run_jacky_oauth_login_pure not found")
        ...
        assert "_OAUTH_TOKEN_USER_AGENT" in source, (
            "run_jacky_oauth_login_pure should send the shared "
