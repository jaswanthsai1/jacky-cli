...
def worker_loop(worker_id: int, jacky_home: str, result_file: str) -> None:
...
def reclaimer_loop(jacky_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="jacky_mixed_stress_")
    print(f"JACKY_HOME = {home}")
