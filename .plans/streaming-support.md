# Streaming LLM Response Support for Jacky Agent
...
```
JACKY_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("JACKY_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `jacky_cli/config.py` | 1 | +streaming config defaults |
