...
Entry point: ``jacky whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``jacky_cli/main.py``).
...
Jacky gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print()
    print(">_ WhatsApp Business Cloud API Setup")
    print("=" * 50)
    print()
    print("This wizard configures Jacky to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Jacky needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Jacky gateway in another terminal:")
    print("         jacky gateway")
    print()
    ...
    print()
    print("  Docs: https://jaswanthsai1.github.io/jacky-cli/user-guide/")
