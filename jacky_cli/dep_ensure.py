...
def _has_jacky_agent_browser() -> bool:
    ...
    # install.sh installs globally into $JACKY_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-JackyHome", str(get_jacky_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = jacky_subprocess_env(inherit_credentials=False)
