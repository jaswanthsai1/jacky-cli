"""
Skills configuration for Jacky Agent.
`jacky skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.jacky/config.yaml under:
...
from jacky_cli.config import cfg_get, load_config, save_config
from jacky_cli.colors import Colors, color
from jacky_cli.platforms import PLATFORMS as _PLATFORMS
