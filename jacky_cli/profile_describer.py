...
Used by ``jacky profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Jacky Agent kanban board.
...
Rules:
  ...
  - Never write "Jacky Agent profile" or other meta-narration.
