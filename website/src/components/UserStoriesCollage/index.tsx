  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Jacky Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Jacky &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Jacky?{' '}
        <a
          href="https://github.com/jaswanthsai1/jacky-cli/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
