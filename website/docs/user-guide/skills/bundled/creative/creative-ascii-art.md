...
```bash
python3 -m pyfiglet "JACKY" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=JACKY&font=Slant" | boxes -d stone
```
