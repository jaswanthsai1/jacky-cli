---
title: "Jacky Doctrine — The Jacky hunt-loop doctrine — a full offensive-security / bug-bounty methodology for autonomous agents"
sidebar_label: "Jacky Doctrine"
description: "The Jacky hunt-loop doctrine — a full offensive-security / bug-bounty methodology for autonomous agents"
---
...
| Path | `skills/jacky-doctrine` |
| Version | `1.0.0` |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `methodology`, `doctrine`, `pentest`, `bug-bounty`, `offensive-security`, `agentic-workflow` |
| Related skills | [`bb-methodology`](/user-guide/skills/bundled/bb-methodology/bb-methodology-bb-methodology), [`redteam-mindset`](/user-guide/skills/bundled/redteam-mindset/redteam-mindset-redteam-mindset), [`triage-validation`](/user-guide/skills/bundled/triage-validation/triage-validation-triage-validation), [`recon-scope-triage`](/user-guide/skills/bundled/recon-scope-triage/recon-scope-triage-recon-scope-triage), [`report-writing`](/user-guide/skills/bundled/report-writing/report-writing-report-writing), [`evidence-hygiene`](/user-guide/skills/bundled/evidence-hygiene/evidence-hygiene-evidence-hygiene) |
