---
title: "Recon Scope Triage"
sidebar_label: "Recon Scope Triage"
description: "Triage ASM/recon output for ownership before testing — separate the target's real assets from namespace-collision noise"
---
...
| Path | `skills/recon-scope-triage` |
