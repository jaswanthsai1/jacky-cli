...
sidebar_label: "Evidence Hygiene"
description: "Evidence-capture and PoC-redaction discipline for bug-bounty submissions: cookie redaction protocol (which fields to mask, Preview annotation / Burp panel hi..."
---
...
- Your test account email/UID (use a platform-provided alias or anonymized test account where the program supports one)
