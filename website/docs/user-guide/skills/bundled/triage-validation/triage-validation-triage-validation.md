...
sidebar_label: "Triage Validation"
description: "Finding validation before writing any report — 7-Question Gate (all 7 questions), 4 pre-submission gates, always-rejected list, conditionally valid with chai..."
---
