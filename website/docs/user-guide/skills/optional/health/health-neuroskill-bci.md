...
| | |
|---|---|
| Source | Optional — install with `jacky skills install official/health/neuroskill-bci` |
...
Connect Jacky to a running [NeuroSkill](https://neuroskill.com/) instance to read
