...
| | |
|---|---|
| Source | Optional — install with `jacky skills install official/research/qmd` |
...
Jacky Agent via the native MCP client. This is the preferred
...
Then configure Jacky Agent to connect via HTTP:
