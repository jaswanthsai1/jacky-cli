...
| | |
|---|---|
| Source | Optional — install with `jacky skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Jacky Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $JACKY_OSINT_CACHE/icij/ (default: ~/.cache/jacky-osint/icij/).
...
# Set JACKY_OSINT_UA=your-app/1.0 (your@email) to identify yourself
