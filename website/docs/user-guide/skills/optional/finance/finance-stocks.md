...
| | |
|---|---|
| Source | Optional — install with `jacky skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Jacky Agent |
| License | MIT |
...
```
SCRIPT=~/.jacky/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.jacky/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
