...
| | |
|---|---|
| Source | Optional — install with `jacky skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.jacky/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.jacky/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Jacky installs package this)
