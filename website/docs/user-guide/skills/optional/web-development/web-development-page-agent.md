...
- User wants **Jacky itself to drive a browser** → use Jacky' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
