...
| | |
|---|---|
| Source | Optional — install with `jacky skills install official/mlops/lambda-labs` |
...
- **[Advanced Usage](https://github.com/jaswanthsai1/jacky-cli/blob/main/optional-skills/mlops/lambda-labs/references/advanced-usage.md)** - Multi-node training, API automation
- **[Troubleshooting](https://github.com/jaswanthsai1/jacky-cli/blob/main/optional-skills/mlops/lambda-labs/references/troubleshooting.md)** - Common issues and solutions
