...
| | |
|---|---|
| Source | Optional — install with `jacky skills install official/mlops/modal` |
...
- **[Advanced Usage](https://github.com/jaswanthsai1/jacky-cli/blob/main/optional-skills/mlops/modal/references/advanced-usage.md)** - Multi-GPU, distributed training, cost optimization
- **[Troubleshooting](https://github.com/jaswanthsai1/jacky-cli/blob/main/optional-skills/mlops/modal/references/troubleshooting.md)** - Common issues and solutions
