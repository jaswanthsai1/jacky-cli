...
| | |
|---|---|
| Source | Optional — install with `jacky skills install official/mlops/qdrant` |
...
- **[Advanced Usage](https://github.com/jaswanthsai1/jacky-cli/blob/main/optional-skills/mlops/qdrant/references/advanced-usage.md)** - Distributed mode, hybrid search, recommendations
- **[Troubleshooting](https://github.com/jaswanthsai1/jacky-cli/blob/main/optional-skills/mlops/qdrant/references/troubleshooting.md)** - Common issues, debugging, performance tuning
