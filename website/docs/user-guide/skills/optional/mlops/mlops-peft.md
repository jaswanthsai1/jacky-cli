...
| | |
|---|---|
| Source | Optional — install with `jacky skills install official/mlops/peft` |
...
- **[Advanced Usage](https://github.com/jaswanthsai1/jacky-cli/blob/main/optional-skills/mlops/peft/references/advanced-usage.md)** - DoRA, LoftQ, rank stabilization, custom modules
- **[Troubleshooting](https://github.com/jaswanthsai1/jacky-cli/blob/main/optional-skills/mlops/peft/references/troubleshooting.md)** - Common errors, debugging, optimization
