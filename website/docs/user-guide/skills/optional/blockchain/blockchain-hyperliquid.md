...
| | |
|---|---|
| Source | Optional — install with `jacky skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Jacky Agent |
| License | MIT |
...
The script reads `${JACKY_HOME:-~/.jacky}/.env` for two optional defaults:
...
Helper script: `~/.jacky/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.jacky/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${JACKY_HOME:-~/.jacky}/.env`.
...
```bash
python3 ~/.jacky/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.jacky/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
