...
| [`jacky-agent`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-jacky-agent) | Configure, extend, or contribute to Jacky Agent. | `autonomous-ai-agents/jacky-agent` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`bb-methodology`](/user-guide/skills/bundled/bb-methodology/bb-methodology-bb-methodology) | Use at the START of any bug bounty hunting session, when switching targets, or when feeling lost about what to do next. Master orchestrator that combines the 5-phase non-linear hunting workflow with the critical thinking framework (devel... | `bb-methodology` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`jacky-doctrine`](/user-guide/skills/bundled/jacky-doctrine/jacky-doctrine-jacky-doctrine) | The Jacky hunt-loop doctrine — a full offensive-security / bug-bounty methodology for autonomous agents. Covers the eight-stage hunt loop (scope, recon, rank, enumerate, test, validate, chain, report), parallel workstream execution, a li... | `jacky-doctrine` |
...
| [`petdex`](/user-guide/skills/bundled/productivity/productivity-petdex) | Install and select animated petdex mascots for Jacky. | `productivity/petdex` |
...
| [`teams-meeting-pipeline`](/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline) | Operate the Teams meeting summary pipeline via Jacky CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions. | `productivity/teams-meeting-pipeline` |

## recon-scope-triage

| Skill | Description | Path |
|-------|-------------|------|
| [`recon-scope-triage`](/user-guide/skills/bundled/recon-scope-triage/recon-scope-triage-recon-scope-triage) | Triage ASM/recon output for ownership before testing — separate the target's real assets from namespace-collision noise. Automated recon keyword-matches on the brand name, so for any target whose name is a common/dictionary word, the out... | `recon-scope-triage` |

## redteam-mindset

| Skill | Description | Path |
|-------|-------------|------|
| [`redteam-mindset`](/user-guide/skills/bundled/redteam-mindset/redteam-mindset-redteam-mindset) | Red-team operator discipline — the mindset corrections that separate offensive testing from defensive WAPT. Built from authorized red-team work where conservative defaults caused multiple findings to be missed and one to be incorrectly r... | `redteam-mindset` |

## report-writing

| Skill | Description | Path |
|-------|-------------|------|
| [`report-writing`](/user-guide/skills/bundled/report-writing/report-writing-report-writing) | Bug bounty report writing for H1/Bugcrowd/Intigriti/Immunefi — report templates, human tone guidelines, impact-first writing, CVSS 3.1 scoring, title formula, impact statement formula, severity decision guide, downgrade counters, pre-sub... | `report-writing` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`jacky-agent-skill-authoring`](/user-guide/skills/bundled/software-development/software-development-jacky-agent-skill-authoring) | Author in-repo SKILL.md: frontmatter, validator, structure, and writing-quality principles. | `software-development/jacky-agent-skill-authoring` |
...
| [`plan`](/user-guide/skills/bundled/software-development/software-development-plan) | Plan mode: write an actionable markdown plan to .jacky/plans/, no execution. Bite-sized tasks, exact paths, complete code. | `software-development/plan` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`triage-validation`](/user-guide/skills/bundled/triage-validation/triage-validation-triage-validation) | Finding validation before writing any report — 7-Question Gate (all 7 questions), 4 pre-submission gates, always-rejected list, conditionally valid with chain table, CVSS 3.1 quick reference, severity decision guide, report title formula... | `triage-validation` |
