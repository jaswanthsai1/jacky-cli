...
| [`jacky-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-jacky-agent) | Configure, extend, or contribute to Jacky Agent. | `autonomous-ai-agents/jacky-agent` |
...
| [`petdex`](/docs/user-guide/skills/bundled/productivity/productivity-petdex) | Install and select animated petdex mascots for Jacky. | `productivity/petdex` |
...
| [`teams-meeting-pipeline`](/docs/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline) | Operate the Teams meeting summary pipeline via Jacky CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions. | `productivity/teams-meeting-pipeline` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`jacky-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-jacky-agent-skill-authoring) | Author in-repo SKILL.md: frontmatter, validator, structure. | `software-development/jacky-agent-skill-authoring` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Plan mode: write an actionable markdown plan to .jacky/plans/, no execution. Bite-sized tasks, exact paths, complete code. | `software-development/plan` |
